...
$pictureBox.Location = New-Object System.Drawing.Point(22, 20)
...
try {
    ...
    $bmp = New-Object System.Drawing.Bitmap(400, 130)
    $g = [System.Drawing.Graphics]::FromImage($bmp)
    $g.Clear([System.Drawing.ColorTranslator]::FromHtml("#10121b"))
...
$title.Location = New-Object System.Drawing.Point(22, 165)
...
$console.Size = New-Object System.Drawing.Size(400, 90)
$console.Location = New-Object System.Drawing.Point(22, 360)
$console.BackColor = [System.Drawing.ColorTranslator]::FromHtml("#050608")
...
$btnPriority.Location = New-Object System.Drawing.Point(22, 270)
$btnPriority.FlatStyle = "Flat"
$btnPriority.BackColor = [System.Drawing.ColorTranslator]::FromHtml("#ff0055")
$btnPriority.ForeColor = [System.Drawing.Color]::White
$btnPriority.Font = New-Object System.Drawing.Font("Arial", 10, [System.Drawing.FontStyle]::Bold)
$btnPriority.Add_Click({
    $console.Text = "> Activating Priority Lock..."
